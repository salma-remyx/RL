...
def test_nightly_compute_stays_below_3480_hours(nightly_test_suite, tracker):
    ...
    assert total_gpu_hours <= 3480, (
        f"Total GPU hours exceeded 3480: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
